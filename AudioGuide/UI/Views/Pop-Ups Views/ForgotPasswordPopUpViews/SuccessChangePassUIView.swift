//
//  SuccessChangePassUIView.swift
//  AudioGuide
//
//  Created by Максим Оліярник on 21.11.2023.
//

import UIKit

class SuccessChangePassUIView: UIView {
    ...
    let secondaryLabel : UILabel = {
        let label = UILabel()
        label.text = "You successfully changed the password.Let’s Log In with new one."
    ...
    private func addSubviews(){
        ...
        NSLayoutConstraint.activate([
            ...
            successView.heightAnchor.constraint(equalToConstant: 333),
        ...
        NSLayoutConstraint.activate([
            ...
            imageView.topAnchor.constraint(equalTo: successView.topAnchor,constant: 39),
            imageView.widthAnchor.constraint(equalToConstant: 106),
            imageView.heightAnchor.constraint(equalToConstant: 107),
        ])
        ...
        NSLayoutConstraint.activate([
            ...
            secondaryLabel.widthAnchor.constraint(equalToConstant: 247),
